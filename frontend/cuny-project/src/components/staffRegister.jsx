...
function StaffRegister() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://127.0.0.1:5000/staffRegister', formData);
    ...
    <div className="register-container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <p className="input-label">EMAIL</p>
          <input type="email" name='email' placeholder="Enter Email" pattern="[a-zA-Z0-9!@#$%^*_|]{0,100}"  value={formData.email} onChange={handleChange} required/>
        </div>
        <div className="input-group">
        ...
        <div className="input-group">
          ...
          <select name='school' value={setFormData.school}onChange={handleChange} required>
